...
class ExchangeCard extends StatefulWidget {
  const ExchangeCard({Key? key, this.snapshot}) : super(key: key);
...
class _ExchangeCardState extends State<ExchangeCard> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Text('Total Exchange: ${widget.snapshot!.docs.length}', style: TextStyle(fontSize: 20, color: Colors.white),),
    ),
    ),
    ListView.builder(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Location: ${exchange.exchangeAddress.toString()}',
                    style: TextStyle(
                      fontSize: 22, color: Colors.black),),
